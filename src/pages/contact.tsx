...
import { AtSign, Globe, Hash, MapPin, Phone, Mail, Clock, CheckCircle2, ArrowRight, MessageSquare, Calendar, Send } from "lucide-react";
import logoIcon from "@assets/image_1775695227438.svg";
      ...
      <section className="relative pt-36 pb-20 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute right-0 top-0 bottom-0 flex items-center pr-0 select-none pointer-events-none">
            <img src={logoIcon} alt="" className="max-w-[70vw] h-auto" style={{ width: "min(420px, 70vw)", opacity: 0.12, mixBlendMode: "screen" }} />
          </div>
        </div>
